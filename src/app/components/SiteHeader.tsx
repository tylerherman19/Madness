...
const links = [
 {href:'/',label:'Home',icon:'M3 3h7v7H3z M14 3h7v7h-7z M3 14h7v7H3z M14 14h7v7h-7z'},
 {href:'/pick',label:'Make Pick',icon:'m5 12 4 4L19 6 M4 3h16v18H4z'},
 {href:'/schedule',label:'Games',icon:'M3 12h4l3-7 4 14 3-7h4'},
 {href:'/live',label:'Live',icon:'M3 17 8 7l4 7 4-11 5 14 M3 21h18'},
...
export default function SiteHeader({signupsClosed=false,account}:{signupsClosed?:boolean;mode?:CompetitionMode;account?:string}) {
 ...
 <Link className={s.wordmark} href="/" aria-label="Madness overview"><span className={s.brandIcon}><Ball/></span><span className={s.brandLockup}>MADNESS<small>PICK &amp; PRAY</small></span></Link>
