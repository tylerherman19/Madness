...
export default function LiveTicker({label}:{slateNumber?:number|null;season?:number|null;label?:string|null}){
 ...
 const viewport=useRef<HTMLDivElement>(null),raf=useRef(0),last=useRef(0),idle=useRef(0),interacting=useRef(false)
